            ...
            <div class="col l-9 shop-sanpham">
                <div class="shop-sanpham-title">
                    <?php
                        ...
                        $sql = "SELECT count(id) as number FROM product WHERE category_id = 41";
                        $data = executeResult($sql);
                        $number = 0;
                ...
                <div class="row">
                    ...
                    $sql = "SELECT * FROM product  WHERE category_id = 41 ORDER BY id DESC limit $index,6";
                    $data = executeResult($sql);
                    foreach($data as $item) {
...
<script>
    ...
    console.log(shop_cuahang_items)
</script>
<?php
