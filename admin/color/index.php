	...
	<div class="col-md-5" >
		<form method="post" action="?" >
			<div class="form-group">
				...
				<label for="" style="font-weight: bold;">Tên màu sắc:</label>
				<input type="text" required="true" class="form-control" name="name" value="<?=$name?>" placeholder="Nhập tên màu sắc">
...
<script>
	...
	function deleteCategory(id) {
		option = confirm('Bạn có chắc chắn muốn xóa màu sắc này không?')
		if(!option) return;
		$.post('form_api.php', {
			'id': id,
			'action': 'delete'
